...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Car car1 = new Car(Brand.BMW,"X5",2005, Color.BLACK,500000,"BEXA");
        ...
        Car car4 = new Car(Brand.MERCEDES,"SLK",2015, Color.WHITE,2000000,"MERIN");
        Car car5 = new Car(Brand.OPEL,"Vectra",2000, Color.GREEN,150000,"АА5555НН");
        Car car6 = new Car(Brand.MERCEDES,"SLK",2005, Color.RED,900000,"АА7007IT");
        Car car7 = new Car(Brand.BMW,"320d",2005, Color.BLUE,100000,"AA7777PH");
